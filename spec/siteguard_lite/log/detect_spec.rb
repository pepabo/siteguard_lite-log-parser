...
RSpec.describe SiteguardLite::Log::Detect do
  ...
  describe '#parse' do
    ...
    context 'when content_type is not empty' do
      let(:sample) {
        <<~EOD
          1531397957.965300      0 192.168.0.100 TCP_MISS/000 0 GET http://example.com/?p=<script>alert(%22hello%22)</script> - DIRECT/192.168.1.100 multipart/form-data DETECT-STAT:WAF:RULE_SIG/PART_PARAM_VALUE|PART_GET_PARAM/Content-Type/OFFICIAL/00102001/xss-tag-1:multipart-form-data:%3cscript%3e:%3cscript%3ealert(%22hello%22)%3c/script%3e: ACTION:BLOCK: JUDGE:BLOCK:0: SEARCH-KEY:1531397957.965300.76402:
        EOD
      }
